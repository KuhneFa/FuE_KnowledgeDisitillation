...
saving_directory = "/Users/fabiankassner/Documents/2 Semester/FuE_KnowledgeDisitillation/llama_1b" #"/data/horse/ws/faku637g-specimen/llama_1b" #input("Zur Auswahl stehen: phi3, phi3more qwen, phi, mistral, llama3. Welches LLM Model soll verwendet werden? ")
...
#model_name =  "/data/horse/ws/faku637g-specimen/student_models/llama_1B_sharding_4" #"meta-llama/Llama-3.2-3B-Instruct"
...
def call_LLM(prompt):
    ...
    sequences_tensor = generation_output.sequences

    gen_sequence = sequences_tensor[0, inputs["input_ids"].shape[1]:]
...
for iteration in range(amount_of_epk):
    ...
    file = f'epc_data_simple/epc_{iteration}.json' #'graphs/epc_11360__0.5169854086147916.json'

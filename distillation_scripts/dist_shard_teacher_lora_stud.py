...
teacher_model_name = "meta-llama/Llama-3.1-70B-Instruct" #tiiuae/Falcon3-10B-Instruct #"deepseek-ai/DeepSeek-V3"  # Beispiel
...
lora_config = LoraConfig(
    ...
    lora_dropout=0.05,
    bias="none",
    task_type=TaskType.CAUSAL_LM  # z.B. bei GPT/Llama
)

# 2) Student initialisieren
student_model_name =   "meta-llama/Llama-3.1-8B-Instruct"  #"microsoft/phi-4" Beispiel: kleineres Modell

...
teacher_model_name = "gpt2" #"meta-llama/Llama-3.1-70B-Instruct" #tiiuae/Falcon3-10B-Instruct #"deepseek-ai/DeepSeek-V3"  # Beispiel
teacher_model, teacher_tokenizer = load_fsdp_teacher(teacher_model_name)

# 2) Student initialisieren
student_model_name = "gpt2" #"microsoft/phi-4" #"meta-llama/Llama-3.2-1B-Instruct"  # Beispiel: kleineres Modell
